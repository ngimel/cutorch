...
luaL_error(L, "expected arguments: [*CudaTensor*] CudaTensor~3D CudaTensor~3D");
if(arg1_idx)
lua_pushvalue(L, arg1_idx);
else
luaT_pushudata(L, arg1, "torch.CudaTensor");
...
luaL_error(L, "expected arguments: [*CudaTensor*] [float] CudaTensor~3D [float] CudaTensor~3D CudaTensor~3D");
if(arg1_idx)
lua_pushvalue(L, arg1_idx);
else
luaT_pushudata(L, arg1, "torch.CudaTensor");
...
luaL_error(L, "expected arguments: [*CudaTensor*] CudaTensor [index]");
if(arg1_idx)
lua_pushvalue(L, arg1_idx);
else
luaT_pushudata(L, arg1, "torch.CudaTensor");
...
luaL_error(L, "expected arguments: [*CudaTensor*] CudaTensor float | [*CudaTensor*] float CudaTensor");
if(argset == 1)
{
if(arg1_idx)
lua_pushvalue(L, arg1_idx);
...
luaL_error(L, "expected arguments: *CudaTensor~3D* [CudaTensor~3D] [float] CudaTensor~3D CudaTensor~3D | *CudaTensor~3D* float [CudaTensor~3D] float CudaTensor~3D CudaTensor~3D");
if(argset == 1)
{
lua_pushvalue(L, arg1_idx);
THCudaTensor_baddbmm(default_arg1,arg1,arg2,arg3,arg4,arg5,arg6);
